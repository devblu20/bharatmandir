...
import { MapPin, Clock, QrCode, ExternalLink, ChevronRight, Train, Plane } from 'lucide-react';
        ...
        <div className="detail-hero-content">
          ...
          {translating && (
            <div style={{
              ...
              background: 'rgba(232,101,10,0.15)', border: '1px solid var(--saffron)',
              color: 'var(--gold-light)', padding: '4px 14px', borderRadius: 50,
              fontSize: 12, fontFamily: 'var(--font-hindi)', marginBottom: 12,
            }}>
              ⏳ अनुवाद हो रहा है...
            </div>
          )}
          ...
          <div className="detail-quick-meta">
            ...
            {displayTemple.opening_time  && (
              <span className="detail-meta-item"><Clock size={14} />{displayTemple.opening_time} – {displayTemple.closing_time}</span>
            )}
      ...
      <div className="container">
        <div className="detail-body">
          ...
          <div className="detail-main">
            ...
            {mantras.length > 0 && (
              <div className="detail-section">
                <div className="detail-sec-title"><span className="sec-icon">🕉️</span>{t('detail.mantras_title')}</div>
                {mantras.map((m) => (
            ...
            {festivals.length > 0 && (
              <div className="detail-section">
                <div className="detail-sec-title"><span className="sec-icon">🎉</span>{t('detail.festivals_title')}</div>
                {festivals.map((f, i) => (
            ...
            {sevas.length > 0 && (
              <div className="detail-section">
                <div className="detail-sec-title"><span className="sec-icon">🙏</span>{t('detail.sevas_title')}</div>
                {sevas.map((s) => (
          ...
          <div className="detail-sidebar">
            ...
            <div className="sidebar-card">
              ...
              {displayTemple.entry_fee !== null && <QuickRow label={t('detail.entry_fee')} value={displayTemple.entry_fee === 0 ? t('detail.free') : `₹${displayTemple.entry_fee}`} />}
